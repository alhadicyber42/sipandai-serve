...
export const DashboardLayout = ({
  ...
  return <div className="min-h-screen w-full flex bg-gradient-to-br from-background via-background to-muted/20">
    ...
    {/* Sidebar */}
    <aside className={cn("fixed lg:sticky top-0 left-0 h-screen bg-gradient-to-b from-slate-900 via-indigo-950 to-slate-900 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 text-white transition-all duration-300 z-40 flex flex-col w-64", isSidebarOpen ? "translate-x-0 shadow-2xl border-r border-white/10" : "-translate-x-full lg:translate-x-0 lg:shadow-2xl lg:border-r lg:border-white/10")}>
      {/* Logo */}
