  ...
  return <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/40 dark:from-slate-950 dark:via-blue-950/30 dark:to-indigo-950/40 flex flex-col overflow-x-hidden relative">
        ...
        transition: 'transform 0.3s ease-out'
            ...
            <nav className="border-b border-white/20 bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl supports-[backdrop-filter]:bg-white/60 dark:supports-[backdrop-filter]:bg-slate-900/60 sticky top-0 z-50 shadow-lg shadow-black/5">
                <div className="container flex h-20 items-center justify-between px-4 md:px-6">
                    ...
                    <div className="flex items-center gap-3 md:gap-4">
                        <Button variant="ghost" size="lg" className="text-sm md:text-base font-semibold hover:bg-blue-50 dark:hover:bg-blue-950" onClick={() => navigate("/auth")}>
                            Masuk
                        </Button>
                        <Button onClick={() => navigate("/auth?tab=register")} size="lg" className="gap-2 text-sm md:text-base font-semibold bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 transition-all hover:scale-105">
            ...
            <section className="relative flex-1 flex items-center pt-20 pb-32 lg:pt-32 lg:pb-48 overflow-hidden">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-10 animate-in fade-in slide-in-from-left duration-1000">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Button size="lg" className="text-lg px-10 h-14 font-bold bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 shadow-2xl shadow-blue-500/40 hover:shadow-blue-500/60 transition-all hover:scale-105 group" onClick={() => navigate("/auth?tab=register")}>
                                    Mulai Sekarang
                                    <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
                                </Button>
                                <Button size="lg" variant="outline" className="text-lg px-10 h-14 font-semibold border-2 hover:bg-blue-50 dark:hover:bg-blue-950 transition-all hover:scale-105" onClick={() => navigate("/auth")}>
                                    Masuk ke Akun
                                </Button>
                            </div>
                ...
                icon: Zap,
                text: "Proses Instan"
              }].map((item, i) => <div key={i} className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm border border-white/20">
                        ...
                        <div className="relative animate-in fade-in slide-in-from-right duration-700 delay-300">
                            ...
                            <Card className="relative p-10 shadow-2xl border-2 border-white/20 bg-gradient-to-br from-white/80 to-white/40 dark:from-slate-900/80 dark:to-slate-800/40 backdrop-blur-xl">
                                <div className="space-y-8">
                                    ...
                                    <Button className="w-full h-14 text-lg font-bold bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 shadow-lg shadow-blue-500/30 group" size="lg" onClick={() => navigate("/auth?tab=register")}>
                                        Bergabung Sekarang
                                        <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
                                    </Button>
                                </div>
                ...
                <div className="container px-4 md:px-6 relative z-10">
                    <div className="max-w-4xl mx-auto text-center space-y-10 text-white">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                            <Button size="lg" className="text-lg px-10 h-16 font-bold bg-white text-blue-600 hover:bg-white/90 shadow-2xl shadow-black/20 hover:scale-105 transition-all group" onClick={() => navigate("/auth?tab=register")}>
                                Daftar Gratis Sekarang
                                <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
                            </Button>
                            <Button size="lg" variant="outline" className="text-lg px-10 h-16 font-semibold bg-transparent text-white border-2 border-white/30 hover:bg-white/10 hover:scale-105 transition-all" onClick={() => navigate("/auth")}>
                                Masuk ke Akun
                            </Button>
                        </div>
                    </div>
                ...
                <div className="container px-4 md:px-6">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
                            ...
                            <button onClick={() => navigate("/privacy")} className="text-sm text-muted-foreground hover:text-blue-600 transition-colors font-medium">
                                Kebijakan Privasi
                            </button>
                        </div>
                    </div>
...
function StatCard({
  ...
  return <div className="text-center space-y-3 group cursor-default">
...
function BenefitItem({
  ...
  return <div className="flex gap-5 p-5 rounded-2xl hover:bg-white/50 dark:hover:bg-slate-800/50 transition-all group cursor-default">
