                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle className="flex items-center gap-2">
                                ...
                                Penilaian Final ({filteredAggregatedRatings.length})
                            </CardTitle>
                            <CardDescription>
                                Berikan penilaian final untuk menentukan Employee of The Month
                            </CardDescription>
                                                    ...
                                                    <TableCell className="text-right pr-4">
                                                        <div className="flex items-center justify-end gap-2">
                                                            ...
                                                            {(() => {
                                                                ...
                                                                // Filter employees by same period and category for monthly
                                                                ...
                                                                // Find top employee in this category and period (monthly)
                                                                ...
                                                                // Only show buttons for top employees
                                                                if (!isTopMonthly && !isTopYearly) return null;
                                                                
                                                                return (
                                                                    <div className="flex flex-col gap-1">
                                                                        {/* Monthly button - only for top monthly */}
                                                                        {isTopMonthly && (
                                                                            monthlyWinner ? (
                                                                                <Button
                                                                                    variant="outline"
                                                                                    size="sm"
                                                                                    onClick={() => removeDesignatedWinner(monthlyWinner.id)}
                                                                        ...
                                                                        {/* Yearly button - only for top yearly */}
                                                                        {isTopYearly && (
                                                                            yearlyWinner ? (
                                                                                <Button
                                                                                    variant="outline"
